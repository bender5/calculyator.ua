...
public class JPanelApp extends JPanel 
{
 ...
 b1.addActionListener((ActionEvent arg1) -> {
 ...
 b2.addActionListener((ActionEvent arg1) -> {
 ...
 b3.addActionListener((ActionEvent arg1) -> {
 ...
 b4.addActionListener((ActionEvent arg1) -> {
 ...
 b5.addActionListener((ActionEvent arg1) -> {
 ...
 b6.addActionListener((ActionEvent arg1) -> {
 ...
 b7.addActionListener((ActionEvent arg1) -> {
 ...
 b8.addActionListener((ActionEvent arg1) -> {
 ...
 b9.addActionListener((ActionEvent arg1) -> {
 ...
 b0.addActionListener((ActionEvent arg1) -> {
 ...
 bPlus.addActionListener((ActionEvent arg1) -> {
     res = Integer.valueOf(txt1.getText());
     txt1.setText("");
     op = "+";
 });
 
 bMinus.addActionListener((ActionEvent arg1) -> {
     res = Integer.valueOf(txt1.getText());
     txt1.setText("");
     op = "-";
 });
 
 bMulti.addActionListener((ActionEvent arg1) -> {
     res = Integer.valueOf(txt1.getText());
     txt1.setText("");
     op = "*";
 });
 
 bDivision.addActionListener((ActionEvent arg1) -> {
     res = Integer.valueOf(txt1.getText());
     txt1.setText("");
     op = "/";
 });
 
 bRes.addActionListener((ActionEvent arg0) -> {
     int num = res;
     int num1 = res1;
     String strOp = op;
